...
public class HttpRequest {
    ...
    /**
     * 百度外卖：向指定 URL 发送POST方法的请求（json请求）
     * 增加了几个头域
     * @param url
     *            发送请求的 URL
     * @param param
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendPostBaiDu(String url, String param) {
        ...
        try {
            ...
            conn.setRequestProperty("signature", MD5Utils.MD5Encode("baiduwaimai"+timestamp+param, "UTF-8"));
