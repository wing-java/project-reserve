...
public class OrderGoodsTemp implements Serializable{
	...
	public String toString() {
		return "OrderGoodsTemp [id=" + id + ", order_id=" + order_id + ", character_type=" + character_type
				+ ", goods_id=" + goods_id + ", goods_detail_id=" + goods_detail_id + ", goods_name=" + goods_name
				+ ", goods_num=" + goods_num + ", goods_detail_show=" + goods_detail_show + ", character_value="
				+ character_value + ", express_cash=" + express_cash + ", underline_cash=" + underline_cash + ", cash="
				+ cash + ", gift_info=" + gift_info + "]";
	}
}
