...
public class AsyncFactory
{
    ...
    public static TimerTask syncSessionToDb(final OnlineSession session)
    {
        return new TimerTask()
        {
            ...
            public void run()
            {
                ...
                //登录地址
                online.setLoginLocation(IpAddressUtils.getAddressByIP(session.getHost()));
                //浏览器类型
    ...
    public static TimerTask recordOper(final OperLog operLog)
    {
        return new TimerTask()
        {
            ...
            {
                // 远程查询操作地点
                operLog.setOperLocation(IpAddressUtils.getAddressByIP(operLog.getOperIp()));
    ...
    public static TimerTask recordLogininfor(final String username, final String status, final String message, final Object... args)
    {
        ...
        return new TimerTask()
        {
            ...
            public void run()
            {
                ...
                s.append(IpAddressUtils.getAddressByIP(ip));
                ...
                logininfor.setLoginLocation(IpAddressUtils.getAddressByIP(ip));
