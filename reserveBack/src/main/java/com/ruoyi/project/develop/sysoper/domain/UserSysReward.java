...
/**
 * 参数表 t_user_sys_reward
 * 
 * @author ruoyi
 * @date 2019-05-17
 */
public class UserSysReward extends BaseEntity
{
	...
	public String toString() {
		return "UserSysReward [id=" + id + ", order_id=" + order_id + ", user_id=" + user_id + ", sys_user_account="
				+ sys_user_account + ", uid=" + uid + ", register_type=" + register_type + ", user_tel=" + user_tel
				+ ", user_email=" + user_email + ", nick_name=" + nick_name + ", purse_type=" + purse_type + ", num="
				+ num + ", remark=" + remark + ", cre_date=" + cre_date + "]";
	}
